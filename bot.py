...
from aiogram.types import Message, FSInputFile, ReplyKeyboardMarkup, KeyboardButton, InlineKeyboardButton, InlineKeyboardMarkup
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/6bad2a93e7416363a35bbb0b/latest/USD"
    try:
